...
def get_data(filters):
    ...
    compras_query = f"""
        SELECT
            ...
            SUM(CASE WHEN tax.rate = 0 THEN tax.tax_amount_after_discount ELSE 0 END) as base_cero,
            SUM(CASE WHEN tax.rate > 0 THEN tax.tax_amount_after_discount ELSE 0 END) as base_iva,
